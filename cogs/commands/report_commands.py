...
class ReportCommandsCog(commands.Cog):
    ...
    @app_commands.command(name="daily-report", description="Generate today's report for votes >= 50")
    ...
    @app_commands.command(name="mid-week-report", description="Generate mid-week report (non-empty days)")
    @app_commands.guild_only()
    ...
    @app_commands.command(name="weekly-report-top-10", description="Generate top 10 weekly feedback report")
    @app_commands.guild_only()
